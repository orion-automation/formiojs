...
// {
//   'tableHeader': "<tr>\n    {% if (document.getElementsByClassName(\"editgrid-table-body\").length && !component.displayAsPc && document.getElementsByClassName(\"editgrid-table-body\")[0].clientWidth<=500) { %}\n    {% } else{ %}\n    {% util.eachComponent(components, function(component) { %}\n    {% if (!component.hasOwnProperty('tableView') || component.tableView) { %}\n      <td class=\"editgrid-table-column\">{{ component.label }}</td>\n    {% } %}\n    {% }) %}\n    {% if (!instance.options.readOnly && !instance.disabled) { %}\n        <td class=\"editgrid-table-column\">Actions</td>\n    {% } %}\n    {% } %}\n  </tr>",
//   'tableRow': "{% if (document.getElementsByClassName(\"editgrid-table-body\").length && !component.displayAsPc && document.getElementsByClassName(\"editgrid-table-body\")[0].clientWidth<=500) { %}\n{% util.eachComponent(components, function(component) { %}\n{% if (!component.hasOwnProperty('tableView') || component.tableView) { %}\n  <td class=\"editgrid-table-mobile-row\">\n  <div class=\"editgrid-table-mobile-header\">\n    {{ component.label }}\n  </div>\n  <div class=\"editgrid-table-mobile-cell\">\n    {{ getView(component, row[component.key]) }}\n  </div>\n  </td>\n{% } %}\n{% }) %}\n{% if (!instance.options.readOnly && !instance.disabled) { %}\n  <td class=\"editgrid-table-mobile-row\">\n  <div class=\"editgrid-table-mobile-header\">\n    Action\n  </div>\n  <div class=\"editgrid-table-mobile-cell\">\n    <div class=\"btn-group\">\n      <button class=\"btn btn-default btn-light btn-sm editRow\" aria-label=\"{{ t('Edit row') }}\"><i class=\"{{ iconClass('edit') }}\"></i></button>\n      {% if (!instance.hasRemoveButtons || instance.hasRemoveButtons()) { %}\n      <button class=\"btn btn-danger btn-sm removeRow\" aria-label=\"{{ t('Remove row') }}\"><i class=\"{{ iconClass('trash') }}\"></i></button>\n      {% } %}\n    </div>\n  </div>\n  </td>\n{% } %}\n{% } else{ %}\n{% util.eachComponent(components, function(component) { %}\n{% if (!component.hasOwnProperty('tableView') || component.tableView) { %}\n  <td class=\"editgrid-table-column\">\n    {{ getView(component, row[component.key]) }}\n  </td>\n{% } %}\n{% }) %}\n{% if (!instance.options.readOnly && !instance.disabled) { %}\n<td class=\"editgrid-table-column\">\n  <div class=\"btn-group\">\n    <button class=\"btn btn-default btn-light btn-sm editRow\" aria-label=\"{{ t('Edit row') }}\"><i class=\"{{ iconClass('edit') }}\"></i></button>\n    {% if (!instance.hasRemoveButtons || instance.hasRemoveButtons()) { %}\n    <button class=\"btn btn-danger btn-sm removeRow\" aria-label=\"{{ t('Remove row') }}\"><i class=\"{{ iconClass('trash') }}\"></i></button>\n    {% } %}\n  </div>\n</td>\n{% } %}\n{% } %}"
// }
