...
export default class Component extends Element {
  ...
  addCKE(element, settings, onChange) {
    ...
    settings.removePlugins=[
      ...
      'CaseChange','Watchdog','ContextWatchdog','Context','Title','Restricted editing'
    ];

    return Formio.requireLibrary(
      'ckeditor',
      isIEBrowser ? 'CKEDITOR' : 'CKEDITOR.ClassicEditor',
      ...
      .then(() => {
        ...
        if (isIEBrowser) {
          ...
          return CKEDITOR.ClassicEditor.create(element, settings).then(editor => {
  ...
  calculateComponentValue(data, flags, row) {
    ...
    if (allowOverride) {
      ...
      const normalizedDataValue = this.normalizeValue(this.convertNumberOrBoolToString(dataValue))||previousCalculatedValue;
