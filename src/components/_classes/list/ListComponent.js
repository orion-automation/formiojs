...
export default class ListComponent extends Field {
  ...
  get isSelectURL() {
    return this.component.dataSrc === 'url'||this.component.dataSrc === 'noco_db';
  }
  ...
  updateItems(searchInput, forceUpdate) {
    ...
    switch (this.component.dataSrc) {
      ...
      case 'url':
      case 'noco_db': {
        if (!forceUpdate && !this.active && !this.calculatedValue && (this.component.type === 'select'||this.component.type === 'customSelect')) {
